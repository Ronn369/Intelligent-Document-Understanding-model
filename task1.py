...
def reasoning_logic(doc_type, fields):
    ...
    if doc_type == "Invoice":
        if "total_amount" in fields:
            explanation.append(" Found total amount — invoice seems complete.")
        else:
            explanation.append(" Missing total amount — invoice might be incomplete.")
        ...
        explanation.append(" Resume detected — text includes education/skills/experience keywords.")

    elif doc_type == "Purchase Order":
        explanation.append(" Purchase Order detected — includes supplier/order details.")

    else:
        explanation.append(" Document type unknown — needs manual check.")
